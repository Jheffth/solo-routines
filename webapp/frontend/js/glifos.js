...
const Glifos = {
  ...
  _G: {
    ...
    caveira: {    // a marca da penitência — o que sobra de quem não pagou
      base: '<path d="M12 2.6c-4.3 0-7.2 3-7.2 7.1 0 2.4 1 4.3 2.5 5.5v2.6c0 .9.7 1.6 1.6 1.6h6.2c.9 0 1.6-.7 1.6-1.6v-2.6c1.5-1.2 2.5-3.1 2.5-5.5 0-4.1-2.9-7.1-7.2-7.1z"/>',
      traco: '<path d="M12 2.6c-4.3 0-7.2 3-7.2 7.1 0 2.4 1 4.3 2.5 5.5v2.6c0 .9.7 1.6 1.6 1.6h6.2c.9 0 1.6-.7 1.6-1.6v-2.6c1.5-1.2 2.5-3.1 2.5-5.5 0-4.1-2.9-7.1-7.2-7.1z"/>'
           + '<ellipse cx="9.1" cy="10.2" rx="1.9" ry="2.2"/>'
           + '<ellipse cx="14.9" cy="10.2" rx="1.9" ry="2.2"/>'
           + '<path d="M12 13.4l-1 2.1h2z"/>'
